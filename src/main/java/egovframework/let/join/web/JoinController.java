...
public class JoinController {
	...
	public String memberType(@ModelAttribute("searchVO") JoinVO vo,  HttpServletRequest request, 
	...
	public String memberRegist(@ModelAttribute("searchVO") JoinVO vo,  
	...
	public String insertMember(@ModelAttribute("searchVO") JoinVO vo,  
			HttpServletRequest request, ModelMap model) throws Exception{
